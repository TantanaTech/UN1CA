...
#     Boolean which describes whether the device supports Wi-Fi to Cellular.
{
    ...
    GET_BUILD_VAR "TARGET_PRODUCT_SHIPPING_API_LEVEL" "31"
    GET_BUILD_VAR "TARGET_BOARD_API_LEVEL" "31"
    ...
    GET_BUILD_VAR "SOURCE_AUDIO_SUPPORT_ACH_RINGTONE" "false"
    GET_BUILD_VAR "TARGET_AUDIO_SUPPORT_ACH_RINGTONE" "false"
    GET_BUILD_VAR "SOURCE_AUDIO_SUPPORT_DUAL_SPEAKER" "false"
    GET_BUILD_VAR "TARGET_AUDIO_SUPPORT_DUAL_SPEAKER" "false"
    GET_BUILD_VAR "SOURCE_AUDIO_SUPPORT_VIRTUAL_VIBRATION" "false"
    GET_BUILD_VAR "TARGET_AUDIO_SUPPORT_VIRTUAL_VIBRATION" "false"
    GET_BUILD_VAR "SOURCE_CAMERA_SUPPORT_CAMERAX_EXTENSION" "false"
    GET_BUILD_VAR "TARGET_CAMERA_SUPPORT_CAMERAX_EXTENSION" "false"
    GET_BUILD_VAR "SOURCE_CAMERA_SUPPORT_CUTOUT_PROTECTION" "false"
    GET_BUILD_VAR "TARGET_CAMERA_SUPPORT_CUTOUT_PROTECTION" "false"
    GET_BUILD_VAR "SOURCE_CAMERA_SUPPORT_MASS_APP_FLAVOR" "false"
    GET_BUILD_VAR "TARGET_CAMERA_SUPPORT_MASS_APP_FLAVOR" "false"
    GET_BUILD_VAR "SOURCE_CAMERA_SUPPORT_SDK_SERVICE" "false"
    GET_BUILD_VAR "TARGET_CAMERA_SUPPORT_SDK_SERVICE" "false"
    GET_BUILD_VAR "SOURCE_COMMON_CONFIG_MDNIE_MODE" "0"
    GET_BUILD_VAR "TARGET_COMMON_CONFIG_MDNIE_MODE" "0"
    GET_BUILD_VAR "SOURCE_COMMON_SUPPORT_DYN_RESOLUTION_CONTROL" "false"
    GET_BUILD_VAR "TARGET_COMMON_SUPPORT_DYN_RESOLUTION_CONTROL" "false"
    GET_BUILD_VAR "SOURCE_COMMON_SUPPORT_EMBEDDED_SIM" "false"
    GET_BUILD_VAR "TARGET_COMMON_SUPPORT_EMBEDDED_SIM" "false"
    GET_BUILD_VAR "SOURCE_COMMON_SUPPORT_HDR_EFFECT" "false"
    GET_BUILD_VAR "TARGET_COMMON_SUPPORT_HDR_EFFECT" "false"
    GET_BUILD_VAR "SOURCE_DVFSAPP_CONFIG_DVFS_POLICY_FILENAME" "none"
    GET_BUILD_VAR "TARGET_DVFSAPP_CONFIG_DVFS_POLICY_FILENAME" "none"
    GET_BUILD_VAR "SOURCE_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME" "none"
    GET_BUILD_VAR "TARGET_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME" "none"
    GET_BUILD_VAR "SOURCE_FINGERPRINT_CONFIG_SENSOR" "none"
    GET_BUILD_VAR "TARGET_FINGERPRINT_CONFIG_SENSOR" "none"
    GET_BUILD_VAR "SOURCE_LCD_CONFIG_COLOR_WEAKNESS_SOLUTION" "0"
    GET_BUILD_VAR "TARGET_LCD_CONFIG_COLOR_WEAKNESS_SOLUTION" "0"
    GET_BUILD_VAR "SOURCE_LCD_CONFIG_CONTROL_AUTO_BRIGHTNESS" "0"
    GET_BUILD_VAR "TARGET_LCD_CONFIG_CONTROL_AUTO_BRIGHTNESS" "0"
    GET_BUILD_VAR "SOURCE_LCD_CONFIG_HFR_DEFAULT_REFRESH_RATE" "60"
    GET_BUILD_VAR "TARGET_LCD_CONFIG_HFR_DEFAULT_REFRESH_RATE" "60"
    GET_BUILD_VAR "SOURCE_LCD_CONFIG_HFR_MODE" "0"
    GET_BUILD_VAR "TARGET_LCD_CONFIG_HFR_MODE" "0"
    GET_BUILD_VAR "SOURCE_LCD_CONFIG_HFR_SUPPORTED_REFRESH_RATE" "none"
    GET_BUILD_VAR "TARGET_LCD_CONFIG_HFR_SUPPORTED_REFRESH_RATE" "none"
    ...
    GET_BUILD_VAR "SOURCE_LCD_SUPPORT_MDNIE_HW" "false"
    GET_BUILD_VAR "TARGET_LCD_SUPPORT_MDNIE_HW" "false"
    GET_BUILD_VAR "SOURCE_RIL_FEATURES" "none"
    GET_BUILD_VAR "TARGET_RIL_FEATURES" "none"
    GET_BUILD_VAR "SOURCE_RIL_SIM_CONFIG_MULTISIM_TRAYCOUNT" "1"
    GET_BUILD_VAR "TARGET_RIL_SIM_CONFIG_MULTISIM_TRAYCOUNT" "1"
    GET_BUILD_VAR "SOURCE_RIL_SUPPORT_WATERPROOF_SIM_TRAY_MSG" "false"
    GET_BUILD_VAR "TARGET_RIL_SUPPORT_WATERPROOF_SIM_TRAY_MSG" "false"
    ...
    GET_BUILD_VAR "SOURCE_WLAN_CONFIG_CONNECTION_PERSONALIZATION" "0"
    GET_BUILD_VAR "TARGET_WLAN_CONFIG_CONNECTION_PERSONALIZATION" "0"
    GET_BUILD_VAR "SOURCE_WLAN_CONFIG_CPU_CSTATE_DISABLE_THRESHOLD" "0"
    GET_BUILD_VAR "TARGET_WLAN_CONFIG_CPU_CSTATE_DISABLE_THRESHOLD" "0"
    GET_BUILD_VAR "SOURCE_WLAN_CONFIG_CUSTOM_BACKOFF" "none"
    GET_BUILD_VAR "TARGET_WLAN_CONFIG_CUSTOM_BACKOFF" "none"
    GET_BUILD_VAR "SOURCE_WLAN_CONFIG_DATA_ACTIVITY_AFFINITY_BOOSTER_THRESHOLD" "0"
    GET_BUILD_VAR "TARGET_WLAN_CONFIG_DATA_ACTIVITY_AFFINITY_BOOSTER_THRESHOLD" "0"
    GET_BUILD_VAR "SOURCE_WLAN_CONFIG_DYNAMIC_SWITCH" "0"
    GET_BUILD_VAR "TARGET_WLAN_CONFIG_DYNAMIC_SWITCH" "0"
    GET_BUILD_VAR "SOURCE_WLAN_CONFIG_L1SS_DISABLE_THRESHOLD" "0"
    GET_BUILD_VAR "TARGET_WLAN_CONFIG_L1SS_DISABLE_THRESHOLD" "0"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_80211AX" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_80211AX" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_80211AX_6GHZ" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_80211AX_6GHZ" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_APE_SERVICE" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_APE_SERVICE" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_LOWLATENCY" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_LOWLATENCY" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MBO" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MBO" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_5G_BASEDON_COUNTRY" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_5G_BASEDON_COUNTRY" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_6G" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_6G" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_DUALAP" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_DUALAP" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_OWE" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_OWE" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_POWER_SAVEMODE" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_POWER_SAVEMODE" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_PRIORITIZE_TRAFFIC" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_PRIORITIZE_TRAFFIC" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_WIFI_CONCURRENCY" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_WIFI_CONCURRENCY" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_MOBILEAP_WIFISHARING_LITE" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_MOBILEAP_WIFISHARING_LITE" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_SWITCH_FOR_INDIVIDUAL_APPS" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_SWITCH_FOR_INDIVIDUAL_APPS" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_TWT_CONTROL" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_TWT_CONTROL" "false"
    GET_BUILD_VAR "SOURCE_WLAN_SUPPORT_WIFI_TO_CELLULAR" "false"
    GET_BUILD_VAR "TARGET_WLAN_SUPPORT_WIFI_TO_CELLULAR" "false"
} > "$OUT_DIR/config.sh"
