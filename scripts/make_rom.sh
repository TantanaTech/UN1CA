...
# Klasör yollarını elle sabitliyoruz (Logdaki hatanın kesin çözümü)
...
if $BUILD_ROM; then
    ...
    # AYIKLAMA (Extract) - Burada hata vermemesi için download_fw'nin yeri dogru olmalı
    ...
    # Yamalar (unica/patches klasöründeki dosyaların uygulanır)
